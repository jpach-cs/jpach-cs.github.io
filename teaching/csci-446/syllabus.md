...
*   **Lecture:** Tuesday & Thursday 09:30 – 10:45 a.m. in NRB 226


<-- NATURAL RESOURCES BUILDING 226 -->
...
- __Assignments git(75%)__: Regular, individual assignments will primarily be completed during class time;
...
__The use of an external resource does not, by itself, constitute academic misconduct.__<br>
...
* During such a review, the instructor may ask the student to:
  * explain specific lines of code;
...
* Additional University sanctions may apply depending on the circumstances and the University's determination.
...
## Student Learning Outcomes
 ...
 Upon successful completion of this course, students will demonstrate the ability to:
    ...
    R2. Students are aware of the relevant ethical considerations in the field of Artificial Intelligence. 
    R3. Students understand and define the concept of a state space for a problem. 
    R4. Students can describe and implement brute-force search techniques, such as breadth-first, depth-first, and 
    iterative deepening. 
    R5. Students can describe and implement heuristic search techniques such as greedy and A*. 
    R6. Students can describe and implement adversarial search techniques such as minimax and alpha-beta pruning. 
    R7. Students can describe and implement constraint satisfaction techniques such as backtracking and local search 
    methods. 
    R8. Students understand the use of logic (propositional and predicate calculus) as means of representing 
    knowledge in a computer system. 
    R9. Students understand the concept of probabilistic reasoning and can determine when to use this concept.    
    R10. Students are able to apply Bayes theorem to determine conditional probabilities and can use Bayesian 
    networks to model and reason about problems.  
    R11. Students understand the basics of Fuzzy Logic models and how they differ from Bayesian networks  
    R12. Students have a fundamental understanding of neural networks. 

## Expectations:

E1. Students should have a thorough understanding of space and time complexity of data structures and 
algorithms. (CSCI 332)  
...
E4. Students should have a working knowledge of logic and logical methods, including propositional and 
predicate calculus. (CSCI 246) 
