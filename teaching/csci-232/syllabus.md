---
layout: default
title: CSCI 232 — Syllabus
---

[← Back to CSCI 232]({{ '/teaching/csci-232/' | relative_url }})

 (CSCI 232)


# CSCI 232: Algorithms & Data Structures
...
*   **Lecture:** Monday & Friday 09:00 – 09:50 a.m. in SBB 001
*   **Laboratory:** Monday 03:00 – 04:50 p.m. in SBB 001
...
**Required:** _Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, Clifford Stein. Introduction to Algorithms, third edition. MIT Press, 2009_
...
## Student Learning Outcomes
 ...
 Upon successful completion of this course, students will demonstrate the ability to:
    ...
    R1.	Students understand Abstract Data Types (ADTs), how to specify ADTs with UML, logical axioms to help specify behaviors, and how to implement ADTs using a high level object oriented programming language. (CS: 2)
    ...
    R4.	Students understand space and time efficiency of data structures and algorithms. (CS: 1, 6; SE: 1)
